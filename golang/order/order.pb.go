...
const file_order_order_proto_rawDesc = "" +
	...
	"orderItems2h\n" +
	"\x05Order\x123\n" +
	"\x06Create\x12\x13.CreateOrderRequest\x1a\x14.CreateOrderResponse\x12*\n" +
	"\x03Get\x12\x10.GetOrderRequest\x1a\x11.GetOrderResponseB:Z8github.com/skyespirates/microservices-proto/golang/orderb\x06proto3"
...
var file_order_order_proto_depIdxs = []int32{
	2, // 0: CreateOrderRequest.order_items:type_name -> OrderItem
	2, // 1: GetOrderResponse.order_items:type_name -> OrderItem
	0, // 2: Order.Create:input_type -> CreateOrderRequest
	3, // 3: Order.Get:input_type -> GetOrderRequest
	1, // 4: Order.Create:output_type -> CreateOrderResponse
